...
public class ImageUpload extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("http://192.168.43.212:8085/EmployeeTracker/Admin/Resi/upload.jsp?id='"+ id +"'");
        Log.d("swati","http://192.168.43.212:8085/EmployeeTracker/Admin/Resi/upload.jsp?id='" + id + "'");
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ImageUpload.this, Capture.class);
